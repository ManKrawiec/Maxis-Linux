translations = {
            ...
            "Everything is set up for you. Thank you for choosing Maxis.": "Tudo está configurado para você. Obrigado por escolher Maxis.",
            "Reboot the system to finish installation.": "Reinicie o sistema para finalizar a instalação.",
            "Everything is set up for you. Thank you for choosing Maxis.\nReboot the system to finish installation.": "Tudo está configurado para você. Obrigado por escolher Maxis.\nReinicie o sistema para finalizar a instalação.",
            "Reboot": "Reiniciar",
            ...
            "Removing ucode for non-used x86_64 processor": "A remover microcódigo para processador x86_64 não utilizado",
            "Select a partition to install": "Selecione uma partição para instalar",
            "The selected partition will be replaced with Maxis.": "A partição selecionada será substituída pelo Maxis.",
            "Manage your disks": "Gerir os seus discos",
            "Waiting for partitioning tool...": "A aguardar ferramenta de particionamento...",
            "(Remaining space)": "(Espaço restante)",
            "Will split": "Irá dividir",
            "into": "em",
            "The partition list will refresh automatically when you close Disks.": "A lista de partições será atualizada automaticamente quando fechar o Discos.",
            "Maxis (Current One)": "Maxis (Atual)",
            "GNOME-based desktop interface": "Interface de ambiente de trabalho baseada em GNOME",
            "Plasma-based desktop interface": "Interface de ambiente de trabalho baseada em Plasma",
            "Choose Your Option": "Escolha a sua Opção",
            ...
            "Will split <b>{}</b> into:\n1. <b>EFI Boot</b> (512 MB)\n2. <b>Root</b> (Remaining space)": "Dividirá <b>{}</b> em:\n1. <b>Arranque EFI</b> (512 MB)\n2. <b>Raiz</b> (Espaço restante)",
            "Will replace <b>{}</b> with:\n1. <b>Root</b> (Full available space, Bootable)": "Substituirá <b>{}</b> por:\n1. <b>Raiz</b> (Todo o espaço disponível, Arranque)",
            "Partitioning": "Particionamento",
            "Preparing disk...": "A preparar o disco...",
            "Initializing disk partition table...": "A inicializar a tabela de partições...",
            "Unmounting partition...": "A desmontar a partição...",
            "Removing old partition...": "A remover a partição antiga...",
            "Creating new partitions...": "A criar novas partições...",
            "Synchronizing disks...": "A sincronizar discos...",
            "Verifying partitions...": "A verificar partições...",
            "Formatting EFI partition...": "A formatar partição EFI...",
            "Formatting Root partition...": "A formatar partição Root...",
            "Finalizing configuration...": "A finalizar a configuração...",
            "Partitioning Failed": "O particionamento falhou",
            "Could not launch GParted: {}": "Não foi possível iniciar o GParted: {}",
            "Working...": "A trabalhar...",
    "Select the language you want to use for the system.": "Selecione o idioma que pretende utilizar no sistema.",
    "View Installation Log": "Ver registo de instalação",
    "Download Maxis-suggested Flatpaks": "Transferir Flatpaks sugeridos pelo Maxis",
    ...
    "Select a partition to use for /home.\nThis allows you to keep your personal files separate from the system.": "Selecione uma partição para utilizar como /home.\nIsso permite manter os ficheiros pessoais separados do sistema.",
    "Select": "Selecionar",
    "No other suitable partitions found for /home assignment.": "Nenhuma outra partição adequada encontrada para atribuição do /home.",
    "Format partition (Erase all data)": "Formatar partição (Apagar todos os dados)",
    "<span color='red'><b>Format &amp; Use</b></span> (All data on {} will be erased)": "<span color='red'><b>Formatar e Utilizar</b></span> (Todos os dados em {} serão apagados)",
    "<span color='green'><b>Mount &amp; Keep Data</b></span> (Files on {} will be preserved)": "<span color='green'><b>Montar e Manter Dados</b></span> (Os ficheiros em {} serão preservados)",
    "Formatting Home partition...": "A formatar partição Home...",
            "Hyprland setup instructions will be available on your Desktop after installation.": "As instruções de configuração do Hyprland estarão disponíveis no seu Ambiente de Trabalho após a instalação.",
}
