translations = {
            ...
            "Everything is set up for you. Thank you for choosing Maxis.": "Todo está configurado para usted. Gracias por elegir Maxis.",
            "Reboot the system to finish installation.": "Reinicie el sistema para finalizar la instalación.",
            "Everything is set up for you. Thank you for choosing Maxis.\nReboot the system to finish installation.": "Todo está configurado para usted. Gracias por elegir Maxis.\nReinicie el sistema para finalizar la instalación.",
            "Reboot": "Reiniciar",
            ...
            "The selected partition will be replaced with Maxis.": "La partición seleccionada será reemplazada por Maxis.",
            ...
            "Maxis (Current One)": "Maxis (Actual)",
    ...
    "Download Maxis-suggested Flatpaks": "Descargar Flatpaks sugeridos por Maxis",
    ...
    "Formatting Home partition...": "Formateando partición Home...",
            "Hyprland setup instructions will be available on your Desktop after installation.": "Las instrucciones de configuración de Hyprland estarán disponibles en su Escritorio después de la instalación.",
}
