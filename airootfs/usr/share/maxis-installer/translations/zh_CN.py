translations = {
            ...
            "Everything is set up for you. Thank you for choosing Maxis.": "一切都已为您设置好。感谢您选择 Maxis。",
            "Reboot the system to finish installation.": "重新启动系统以完成安装。",
            "Everything is set up for you. Thank you for choosing Maxis.\nReboot the system to finish installation.": "一切都已为您设置好。感谢您选择 Maxis。\n重新启动系统以完成安装。",
            "Reboot": "重新启动",
            ...
            "The selected partition will be replaced with Maxis.": "选定的分区将被 Maxis 替换。",
    ...
    "Download Maxis-suggested Flatpaks": "下载 Maxis 推荐的 Flatpak 应用",
    ...
    "Formatting Home partition...": "正在格式化 Home 分区...",
            "Hyprland setup instructions will be available on your Desktop after installation.": "Hyprland 的配置说明将在安装完成后出现在您的桌面上。",
}
