translations = {
    ...
    "Download Maxis-suggested Flatpaks": "Baixar Flatpaks sugeridos pelo Maxis",
    ...
    "Formatting Home partition...": "Formatando partição Home...",
            "Hyprland setup instructions will be available on your Desktop after installation.": "As instruções de configuração do Hyprland estarão disponíveis na sua Área de Trabalho após a instalação.",
}
