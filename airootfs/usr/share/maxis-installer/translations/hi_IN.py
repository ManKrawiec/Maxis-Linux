translations = {
            ...
            "Everything is set up for you. Thank you for choosing Maxis.": "आपके लिए सब कुछ सेटअप है। Maxis चुनने के लिए धन्यवाद।",
            "Reboot the system to finish installation.": "स्थापना समाप्त करने के लिए सिस्टम रीबूट करें।",
            "Everything is set up for you. Thank you for choosing Maxis.\nReboot the system to finish installation.": "आपके लिए सब कुछ सेटअप है। Maxis चुनने के लिए धन्यवाद।\nस्थापना समाप्त करने के लिए सिस्टम रीबूट करें।",
            "Reboot": "रीबूट",
            ...
            "The selected partition will be replaced with Maxis.": "चयनित विभाजन को Maxis से बदल दिया जाएगा।",
            ...
            "Maxis (Current One)": "Maxis (वर्तमान)",
    ...
    "Download Maxis-suggested Flatpaks": "Maxis द्वारा सुझाए गए Flatpaks डाउनलोड करें",
    ...
    "Formatting Home partition...": "Home विभाजन को प्रारूपित किया जा रहा है...",
            "Hyprland setup instructions will be available on your Desktop after installation.": "Hyprland की सेटअप निर्देश स्थापना के बाद आपके डेस्कटॉप पर उपलब्ध होंगे।",
}
