translations = {
            ...
            "The selected partition will be replaced with Maxis.": "Выбранный раздел будет заменен на Maxis.",
            ...
            "Maxis (Current One)": "Maxis (Текущий)",
    ...
    "Download Maxis-suggested Flatpaks": "Загрузить рекомендованные Maxis Flatpak-пакеты",
    ...
    "Formatting Home partition...": "Форматирование раздела Home...",
            "Hyprland setup instructions will be available on your Desktop after installation.": "Инструкции по настройке Hyprland будут доступны на вашем рабочем столе после установки.",
}
